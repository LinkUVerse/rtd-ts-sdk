...
const findFiles = () => {
	const result = execSync(
		`find packages/dapp-kit -type f \\( -name "*.ts" -o -name "*.tsx" \\) -not -path "*/node_modules/*" -not -path "*/dist/*"`,
		{ encoding: 'utf8' },
	);
	return result
		.trim()
...
const replacements = [
	...
	{
		from: /SuiSignAndExecuteTransactionBlockOutput/g,
		to: 'RtdSignAndExecuteTransactionBlockOutput',
	},
	{
		from: /SuiSignAndExecuteTransactionBlockMethod/g,
		to: 'RtdSignAndExecuteTransactionBlockMethod',
	},
