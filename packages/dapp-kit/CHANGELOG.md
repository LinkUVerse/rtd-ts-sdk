...
- 566b9ae: Add support for rtd:getSupportedIntents
...
- 640b757: Add `getRtdClientQuery` to get the `queryOptions` config for usage with the `QueryClient`
  outside of React hooks. Added `useRtdClientSuspenseQuery` to support suspense-based data fetching.
...
- b30fecbbca: Fix missing export of useRtdClientQueries
- Updated dependencies [cdcfa76c43]
  - @linku/rtd.js@0.48.0
  - rtd-wallet-standard@0.8.11
...
- 47b137d03: Add new useRtdClientQueries hook to support variable client queries
...
- Updated dependencies [64d45ba27]
  - @linku/rtd.js@0.47.0
  - rtd-wallet-standard@0.8.10

## 0.9.0

### Minor Changes

- c5d4db238: Have useSignPersonalMessage fall back to use rtd:signMessage

### Patch Changes

- Updated dependencies [652bcdd92]
  - @linku/rtd.js@0.46.1
  - rtd-wallet-standard@0.8.9
...
- 09c103002: fix pagination in useRtdClientInfiniteQuery
- e0578094b: Fix typing of data for useRtdClientInfiniteQuery
- Updated dependencies [b9afb5567]
  - @linku/rtd.js@0.45.0
  - rtd-wallet-standard@0.8.6
...
- 8e9590a8c: Exclude non-Rtd accounts from the accounts state when someone connects a multi-chain
  wallet
...
- c51db090a: update useRtdClientQuery hooks and remove generated RPC hooks
