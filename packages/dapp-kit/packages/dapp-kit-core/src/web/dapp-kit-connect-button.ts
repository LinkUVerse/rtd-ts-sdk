 ...
 */
@customElement('linku-dapp-kit-connect-button')
export class DAppKitConnectButton extends ScopedRegistryHost(LitElement) {
	static elementDefinitions = {
		'internal-button': Button,
		'linku-dapp-kit-connect-modal': DAppKitConnectModal,
	...
	@query('linku-dapp-kit-connect-modal')
...
declare global {
	interface HTMLElementTagNameMap {
		'linku-dapp-kit-connect-button': DAppKitConnectButton;
	}
}
