...
/**
 * A modal component for connecting to a Rtd wallet, meant to be opened via a trigger button.
 *
 * Opens a modal to let the user select and connect to a wallet.
 *
 * @element linku-dapp-kit-connect-modal
 *
 ...
 */
@customElement('linku-dapp-kit-connect-modal')
