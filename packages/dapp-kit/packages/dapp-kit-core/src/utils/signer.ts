...
import type { PublicKey, SignatureScheme } from 'rtd-typescript/cryptography';
import { SIGNATURE_FLAG_TO_SCHEME, Signer } from 'rtd-typescript/cryptography';
...
import { publicKeyFromRtdBytes } from 'rtd-typescript/verify';
...
export class CurrentAccountSigner extends Signer {
	...
	override getPublicKey(): PublicKey {
		...
		const publicKey = publicKeyFromRtdBytes(new Uint8Array(account.publicKey), {
