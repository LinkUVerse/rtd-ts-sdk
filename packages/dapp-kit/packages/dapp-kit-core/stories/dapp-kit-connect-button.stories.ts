...
const meta = {
	...
	component: 'linku-dapp-kit-connect-button',
	render: (args) =>
		html`<linku-dapp-kit-connect-button
			.modalOptions=${args['modalOptions']}
			.instance=${dAppKit}
		></linku-dapp-kit-connect-button>`,
	tags: ['autodocs'],
} satisfies Meta;
...
export const WithCustomLabel: StoryObj<DAppKitConnectButton> = {
	render: () =>
		html`<linku-dapp-kit-connect-button .instance=${dAppKit}>
			Sign In
		</linku-dapp-kit-connect-button>`,
};
...
export const WithCustomTheme: StoryObj<DAppKitConnectButton> = {
	render: () => html`
		<div>
			...
			<linku-dapp-kit-connect-button .instance=${dAppKit}></linku-dapp-kit-connect-button>
		</div>
	`,
};
...
export const WithCustomTriggerPart: StoryObj<DAppKitConnectButton> = {
	render: () => html`
		...
		<linku-dapp-kit-connect-button class="custom-part-demo" .instance=${dAppKit}>
			Connect
		</linku-dapp-kit-connect-button>
	`,
};
