...
const JSON_RPC_DEPRECATION_NOTICE =
	'@deprecated JSON-RPC APIs are deprecated in the Rtd TypeScript SDK. Use `RtdGrpcClient` from `rtd-typescript/grpc` or `RtdGraphQLClient` from `rtd-typescript/graphql` instead.';
