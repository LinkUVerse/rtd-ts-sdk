...
import { fromBase58, fromHex, toBase58, toHex } from 'rtd-bcs';
...
import { normalizeRtdAddress } from './index.js';

const RTD_ACCUMULATOR_ROOT_OBJECT_ID = normalizeRtdAddress('0xacc');
const ACCUMULATOR_KEY_TYPE_TAG = TypeTagSerializer.parseFromStr(
	'0x2::accumulator::Key<0x2::balance::Balance<0x2::rtd::RTD>>',
);
