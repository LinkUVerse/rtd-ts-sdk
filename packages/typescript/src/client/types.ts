...
import type { EnumOutputShape } from 'rtd-bcs';
import type {
...
export namespace RtdClientTypes {
	...
	export interface ObjectInclude {
		 ...
		 *
		 * Parse with `bcs.Object.parse(object.objectBcs)` from `rtd-typescript/bcs`.
