...
export function allowanceBalance({
	...
	const objectId = normalizeRtdAddress(
	...
	return (tx: Transaction) => {
		...
		return tx.add(
			TransactionCommands.Intent({
				...
				data: {
					objectId,
					funder: reference.funder ? normalizeRtdAddress(reference.funder) : undefined,
...
export const resolveAllowanceBalance: TransactionPlugin = async (
	...
	const allowances = new Map<string, RtdClientTypes.Object<{ content: true }>>();
