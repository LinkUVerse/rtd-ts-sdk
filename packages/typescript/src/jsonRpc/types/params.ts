 ...
 * return values.
 *
 * @deprecated JSON-RPC APIs are deprecated in the Rtd TypeScript SDK. Use `RtdGrpcClient` from
 * `rtd-typescript/grpc` or `RtdGraphQLClient` from `rtd-typescript/graphql` instead.
 */
...
export interface ExecuteTransactionBlockParams {
	...
	options?: RpcTypes.RtdTransactionBlockResponseOptions | null | undefined;
...
export interface GetObjectParams {
	...
	id: string;
	/** options for specifying the content to be returned */
	options?: RpcTypes.RtdObjectDataOptions | null | undefined;
	signal?: AbortSignal;
}
/**
...
export interface GetBalanceParams {
	 ...
	 * default to 0x2::rtd::RTD if not specified.
	 */
 ...
 * `rtd-typescript/grpc` or `RtdGraphQLClient` from `rtd-typescript/graphql` instead.
 */
export interface GetLatestRtdSystemStateParams {
	signal?: AbortSignal;
}
/**
 ...
 * been updated when the next page is fetched. Please use rtdx_queryObjects if this is a concern.
 *
 * @deprecated JSON-RPC APIs are deprecated in the Rtd TypeScript SDK. Use `RtdGrpcClient` from
 * `rtd-typescript/grpc` or `RtdGraphQLClient` from `rtd-typescript/graphql` instead.
 */
export type GetOwnedObjectsParams = {
	...
	limit?: number | null | undefined;
	signal?: AbortSignal;
} & RpcTypes.RtdObjectResponseQuery;
/**
...
export interface QueryEventsParams {
	/**
	 * The event query criteria. See [Event filter](https://docs.rtd.io/build/event_api#event-filters)
	 * documentation for examples.
	 */
	query: RpcTypes.RtdEventFilter;
	/** optional paging cursor */
...
export type QueryTransactionBlocksParams = {
	...
	order?: 'ascending' | 'descending' | null | undefined;
	signal?: AbortSignal;
} & RpcTypes.RtdTransactionBlockResponseQuery;
/**
...
export interface SubscribeEventParams {
	 ...
	 * [Event filter](https://docs.rtd.io/build/event_api#event-filters) documentation for examples.
	 */
	filter: RpcTypes.RtdEventFilter;
	signal?: AbortSignal;
}
/**
...
export interface UnsafeBatchTransactionParams {
	...
	txnBuilderMode?: RpcTypes.RtdTransactionBlockBuilderMode | null | undefined;
	signal?: AbortSignal;
}
/**
...
export interface UnsafeMoveCallParams {
	...
	/**
	 * the arguments to be passed into the Move function, in [RtdJson](https://docs.rtd.io/build/rtd-json)
	 * format
	 */
	arguments: unknown[];
	/**
	 ...
	 * `RtdTransactionBlockBuilderMode::Commit` when it's None.
	 */
	executionMode?: RpcTypes.RtdTransactionBlockBuilderMode | null | undefined;
	signal?: AbortSignal;
}
/**
...
/**
 * Send all RTD coins to one recipient. This is for RTD coin only and does not require a separate gas
 * coin object. Specifically, what pay_all_rtd does are: 1. accumulate all RTD from input coins and
 * deposit all RTD to the first input coin 2. transfer the updated first coin to the recipient and also
 ...
 * `rtd-typescript/grpc` or `RtdGraphQLClient` from `rtd-typescript/graphql` instead.
 */
export interface UnsafePayAllRtdParams {
	/** the transaction signer's Rtd address */
	signer: string;
...
/**
 * Send RTD coins to a list of addresses, following a list of amounts. This is for RTD coin only and
 * does not require a separate gas coin object. Specifically, what pay_rtd does are: 1. debit each
 * input_coin to create new coin following the order of amounts and assign it to the corresponding
 * recipient. 2. accumulate all residual RTD from input coins left and deposit all RTD to the first
 ...
 * `rtd-typescript/grpc` or `RtdGraphQLClient` from `rtd-typescript/graphql` instead.
 */
export interface UnsafePayRtdParams {
	/** the transaction signer's Rtd address */
	signer: string;
	/** the Rtd coins to be used in this transaction, including the coin for gas payment. */
	inputCoins: string[];
...
/**
 * Create an unsigned transaction to send RTD coin object to a Rtd address. The RTD object is also used
 * as the gas object.
 *
 * @deprecated JSON-RPC APIs are deprecated in the Rtd TypeScript SDK. Use `RtdGrpcClient` from
 * `rtd-typescript/grpc` or `RtdGraphQLClient` from `rtd-typescript/graphql` instead.
 */
export interface UnsafeTransferRtdParams {
	/** the transaction signer's Rtd address */
	signer: string;
