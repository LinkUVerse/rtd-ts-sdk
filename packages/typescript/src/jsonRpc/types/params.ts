...
export interface QueryEventsParams {
	/**
	 * The event query criteria. See [Event filter](https://docs.rtd.life/build/event_api#event-filters)
...
export interface SubscribeEventParams {
	 ...
	 * [Event filter](https://docs.rtd.life/build/event_api#event-filters) documentation for examples.
	 */
...
export interface UnsafeMoveCallParams {
	...
	/**
	 * the arguments to be passed into the Move function, in [RtdJson](https://docs.rtd.life/build/rtd-json)
	 * format
	 */
	arguments: unknown[];
	/**
