...
// @generated from protobuf file "rtd/rpc/v2/jwk.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Wenchuan Tech, Inc.
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.JwkId
 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.Jwk
 */
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.JwkId
 */
export const JwkId = new JwkId$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Jwk$Type extends MessageType<Jwk> {
    constructor() {
        super("rtd.rpc.v2.Jwk", [
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.Jwk
 */
