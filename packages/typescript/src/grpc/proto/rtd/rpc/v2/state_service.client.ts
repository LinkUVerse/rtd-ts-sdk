...
/**
 * @generated from protobuf service rtd.rpc.v2.StateService
 */
export interface IStateServiceClient {
	/**
	 * @generated from protobuf rpc: ListDynamicFields(rtd.rpc.v2.ListDynamicFieldsRequest) returns (rtd.rpc.v2.ListDynamicFieldsResponse);
	 */
	listDynamicFields(
	...
	/**
	 * @generated from protobuf rpc: ListOwnedObjects(rtd.rpc.v2.ListOwnedObjectsRequest) returns (rtd.rpc.v2.ListOwnedObjectsResponse);
	 */
	listOwnedObjects(
	...
	/**
	 * @generated from protobuf rpc: GetCoinInfo(rtd.rpc.v2.GetCoinInfoRequest) returns (rtd.rpc.v2.GetCoinInfoResponse);
	 */
	getCoinInfo(
	...
	/**
	 * @generated from protobuf rpc: GetBalance(rtd.rpc.v2.GetBalanceRequest) returns (rtd.rpc.v2.GetBalanceResponse);
	 */
	getBalance(
	...
	/**
	 * @generated from protobuf rpc: ListBalances(rtd.rpc.v2.ListBalancesRequest) returns (rtd.rpc.v2.ListBalancesResponse);
	 */
	listBalances(
