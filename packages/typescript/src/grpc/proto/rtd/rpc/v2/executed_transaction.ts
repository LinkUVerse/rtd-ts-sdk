...
// @generated from protobuf file "rtd/rpc/v2/executed_transaction.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Wenchuan Tech, Inc.
...
/**
 * @generated from protobuf message rtd.rpc.v2.ExecutedTransaction
 */
export interface ExecutedTransaction {
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.Transaction transaction = 2
     */
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.TransactionEffects effects = 4
     */
    ...
    timestamp?: Timestamp;
    /**
     * @generated from protobuf field: repeated rtd.rpc.v2.BalanceChange balance_changes = 8
     */
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.ObjectSet objects = 9
     */
    objects?: ObjectSet;
}
...
class ExecutedTransaction$Type extends MessageType<ExecutedTransaction> {
    constructor() {
        super("rtd.rpc.v2.ExecutedTransaction", [
            ...
            { no: 8, name: "balance_changes", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => BalanceChange },
            { no: 9, name: "objects", kind: "message", T: () => ObjectSet }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.ExecutedTransaction
 */
