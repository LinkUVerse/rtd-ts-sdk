...
/**
 * @generated from protobuf service rtd.rpc.v2.NameService
 */
export interface INameServiceClient {
	/**
	 * @generated from protobuf rpc: LookupName(rtd.rpc.v2.LookupNameRequest) returns (rtd.rpc.v2.LookupNameResponse);
	 */
	lookupName(
	...
	/**
	 * @generated from protobuf rpc: ReverseLookupName(rtd.rpc.v2.ReverseLookupNameRequest) returns (rtd.rpc.v2.ReverseLookupNameResponse);
	 */
	reverseLookupName(
