...
// @generated from protobuf file "rtd/rpc/v2/checkpoint_contents.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Wenchuan Tech, Inc.
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.CheckpointContents
 */
export interface CheckpointContents {
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.CheckpointedTransactionInfo transactions = 4
     */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.CheckpointedTransactionInfo
 */
export interface CheckpointedTransactionInfo {
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.UserSignature signatures = 3
     */
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.AddressAliasesVersion address_aliases_versions = 4
     */
    addressAliasesVersions: AddressAliasesVersion[];
}
/**
 * @generated from protobuf message rtd.rpc.v2.AddressAliasesVersion
 */
...
class CheckpointContents$Type extends MessageType<CheckpointContents> {
    constructor() {
        super("rtd.rpc.v2.CheckpointContents", [
            ...
            { no: 4, name: "transactions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CheckpointedTransactionInfo }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.CheckpointContents
 */
...
class CheckpointedTransactionInfo$Type extends MessageType<CheckpointedTransactionInfo> {
    constructor() {
        super("rtd.rpc.v2.CheckpointedTransactionInfo", [
            ...
            { no: 3, name: "signatures", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UserSignature },
            { no: 4, name: "address_aliases_versions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => AddressAliasesVersion }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.CheckpointedTransactionInfo
 */
...
class AddressAliasesVersion$Type extends MessageType<AddressAliasesVersion> {
    constructor() {
        super("rtd.rpc.v2.AddressAliasesVersion", [
            { no: 1, name: "version", kind: "scalar", opt: true, T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.AddressAliasesVersion
 */
