 ...
 *
 * @generated from protobuf service rtd.rpc.v2.SubscriptionService
 */
export interface ISubscriptionServiceClient {
	 ...
	 * filter.
	 *
	 * @generated from protobuf rpc: SubscribeCheckpoints(rtd.rpc.v2.SubscribeCheckpointsRequest) returns (stream rtd.rpc.v2.SubscribeCheckpointsResponse);
	 */
	 ...
	 *
	 * @generated from protobuf rpc: SubscribeTransactions(rtd.rpc.v2.SubscribeTransactionsRequest) returns (stream rtd.rpc.v2.SubscribeTransactionsResponse);
	 */
	 ...
	 *
	 * @generated from protobuf rpc: SubscribeEvents(rtd.rpc.v2.SubscribeEventsRequest) returns (stream rtd.rpc.v2.SubscribeEventsResponse);
	 */
	subscribeEvents(
