...
// @generated from protobuf file "rtd/rpc/v2/object_reference.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) LinkU Labs, Inc.
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.ObjectReference
 */
...
class ObjectReference$Type extends MessageType<ObjectReference> {
	constructor() {
		super('rtd.rpc.v2.ObjectReference', [
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.ObjectReference
 */
