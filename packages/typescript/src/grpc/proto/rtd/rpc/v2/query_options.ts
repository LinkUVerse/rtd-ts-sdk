...
// @generated from protobuf file "rtd/rpc/v2/query_options.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) LinkU Labs, Inc.
 ...
 * upper bound.
 *
 * @generated from protobuf message rtd.rpc.v2.QueryOptions
 */
export interface QueryOptions {
	 ...
	 *
	 * @generated from protobuf field: optional rtd.rpc.v2.Ordering ordering = 4;
	 */
	ordering?: Ordering;
}
/**
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.Watermark
 */
 ...
 * not send `QueryEnd`.
 *
 * @generated from protobuf message rtd.rpc.v2.QueryEnd
 */
export interface QueryEnd {
	/**
	 * Reason this response stopped.
	 *
	 * @generated from protobuf field: optional rtd.rpc.v2.QueryEndReason reason = 1;
	 */
 ...
 *
 * @generated from protobuf enum rtd.rpc.v2.Ordering
 */
 ...
 *
 * @generated from protobuf enum rtd.rpc.v2.QueryEndReason
 */
	...
	constructor() {
		super('rtd.rpc.v2.QueryOptions', [
			...
			{ no: 3, name: 'before', kind: 'scalar', opt: true, T: 12 /*ScalarType.BYTES*/ },
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['rtd.rpc.v2.Ordering', Ordering, 'ORDERING_'],
			},
		]);
	}
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.QueryOptions
 */
export const QueryOptions = new QueryOptions$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Watermark$Type extends MessageType<Watermark> {
	constructor() {
		super('rtd.rpc.v2.Watermark', [
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.Watermark
 */
export const Watermark = new Watermark$Type();
// @generated message type with reflection information, may provide speed optimized methods
class QueryEnd$Type extends MessageType<QueryEnd> {
	constructor() {
		super('rtd.rpc.v2.QueryEnd', [
			{
				no: 1,
				name: 'reason',
				kind: 'enum',
				opt: true,
				T: () => ['rtd.rpc.v2.QueryEndReason', QueryEndReason, 'QUERY_END_REASON_'],
			},
		]);
	}
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.QueryEnd
 */
