...
// @generated from protobuf file "rtd/rpc/v2/signature_verification_service.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Wenchuan Tech, Inc.
...
import { Bcs } from "./bcs";
/**
 * @generated from protobuf message rtd.rpc.v2.VerifySignatureRequest
 */
export interface VerifySignatureRequest {
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.Bcs message = 1
     */
    message?: Bcs;
    /**
     * The signature to verify.
     *
     * @generated from protobuf field: optional rtd.rpc.v2.UserSignature signature = 2
     */
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.ActiveJwk jwks = 4
     */
    jwks: ActiveJwk[];
}
/**
 * @generated from protobuf message rtd.rpc.v2.VerifySignatureResponse
 */
...
class VerifySignatureRequest$Type extends MessageType<VerifySignatureRequest> {
    constructor() {
        super("rtd.rpc.v2.VerifySignatureRequest", [
            ...
            { no: 4, name: "jwks", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ActiveJwk }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.VerifySignatureRequest
 */
...
class VerifySignatureResponse$Type extends MessageType<VerifySignatureResponse> {
    constructor() {
        super("rtd.rpc.v2.VerifySignatureResponse", [
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.VerifySignatureResponse
 */
export const VerifySignatureResponse = new VerifySignatureResponse$Type();
/**
 * @generated ServiceType for protobuf service rtd.rpc.v2.SignatureVerificationService
 */
export const SignatureVerificationService = new ServiceType("rtd.rpc.v2.SignatureVerificationService", [
