...
/**
 * @generated from protobuf service rtd.rpc.v2.SignatureVerificationService
 */
export interface ISignatureVerificationServiceClient {
	 ...
	 *
	 * @generated from protobuf rpc: VerifySignature(rtd.rpc.v2.VerifySignatureRequest) returns (rtd.rpc.v2.VerifySignatureResponse);
	 */
	verifySignature(
