...
// @generated from protobuf file "rtd/rpc/v2/filter.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) LinkU Labs, Inc.
 ...
 * term.
 *
 * @generated from protobuf message rtd.rpc.v2.TransactionFilter
 */
export interface TransactionFilter {
	/**
	 * Terms are ORed together.
	 *
	 * @generated from protobuf field: repeated rtd.rpc.v2.TransactionTerm terms = 1;
	 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.TransactionTerm
 */
export interface TransactionTerm {
	/**
	 * Literals are ANDed together.
	 *
	 * @generated from protobuf field: repeated rtd.rpc.v2.TransactionLiteral literals = 1;
	 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.TransactionLiteral
 */
export interface TransactionLiteral {
	...
	predicate:
		| {
				 ...
				 *
				 * @generated from protobuf field: rtd.rpc.v2.SenderFilter sender = 2;
				 */
				sender: SenderFilter;
		  }
		| {
				 ...
				 *
				 * @generated from protobuf field: rtd.rpc.v2.AffectedAddressFilter affected_address = 3;
				 */
		...
		| {
				 ...
				 * object.
				 *
				 * @generated from protobuf field: rtd.rpc.v2.AffectedObjectFilter affected_object = 4;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: rtd.rpc.v2.MoveCallFilter move_call = 5;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: rtd.rpc.v2.EmitModuleFilter emit_module = 6;
				 */
		...
		| {
				 ...
				 * specified filter.
				 *
				 * @generated from protobuf field: rtd.rpc.v2.EventTypeFilter event_type = 7;
				 */
		...
		| {
				 ...
				 * stream head.
				 *
				 * @generated from protobuf field: rtd.rpc.v2.EventStreamHeadFilter event_stream_head = 8;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: rtd.rpc.v2.PackageWriteFilter package_write = 9;
				 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.EventFilter
 */
export interface EventFilter {
	/**
	 * Terms are ORed together.
	 *
	 * @generated from protobuf field: repeated rtd.rpc.v2.EventTerm terms = 1;
	 */
	terms: EventTerm[];
}
/**
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.EventTerm
 */
export interface EventTerm {
	/**
	 * Literals are ANDed together.
	 *
	 * @generated from protobuf field: repeated rtd.rpc.v2.EventLiteral literals = 1;
	 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.EventLiteral
 */
export interface EventLiteral {
	...
	predicate:
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: rtd.rpc.v2.EmitModuleFilter emit_module = 3;
				 */
				emitModule: EmitModuleFilter;
		  }
		| {
				 ...
				 *
				 * @generated from protobuf field: rtd.rpc.v2.EventTypeFilter event_type = 4;
				 */
				eventType: EventTypeFilter;
		  }
		| {
				 ...
				 *
				 * @generated from protobuf field: rtd.rpc.v2.EventStreamHeadFilter event_stream_head = 5;
				 */
				eventStreamHead: EventStreamHeadFilter;
		  }
		| {
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.SenderFilter
 */
 ...
 * accumulator events.
 *
 * @generated from protobuf message rtd.rpc.v2.AffectedAddressFilter
 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.AffectedObjectFilter
 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.MoveCallFilter
 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.EmitModuleFilter
 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.EventTypeFilter
 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.EventStreamHeadFilter
 */
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.TransactionTerm
 */
...
class TransactionLiteral$Type extends MessageType<TransactionLiteral> {
	constructor() {
		super('rtd.rpc.v2.TransactionLiteral', [
...
class AffectedAddressFilter$Type extends MessageType<AffectedAddressFilter> {
	constructor() {
		super('rtd.rpc.v2.AffectedAddressFilter', [
			{ no: 1, name: 'address', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
		]);
	}
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.AffectedAddressFilter
 */
...
class AffectedObjectFilter$Type extends MessageType<AffectedObjectFilter> {
	constructor() {
		super('rtd.rpc.v2.AffectedObjectFilter', [
			{ no: 1, name: 'object_id', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
		]);
	}
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.AffectedObjectFilter
 */
...
class EventStreamHeadFilter$Type extends MessageType<EventStreamHeadFilter> {
	constructor() {
		super('rtd.rpc.v2.EventStreamHeadFilter', [
			{ no: 1, name: 'stream_id', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
		]);
	}
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.EventStreamHeadFilter
 */
...
class PackageWriteFilter$Type extends MessageType<PackageWriteFilter> {
	constructor() {
		super('rtd.rpc.v2.PackageWriteFilter', []);
	}
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.PackageWriteFilter
 */
