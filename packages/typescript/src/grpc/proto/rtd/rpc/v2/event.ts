...
// @generated from protobuf file "rtd/rpc/v2/event.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) LinkU Labs, Inc.
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.TransactionEvents
 */
export interface TransactionEvents {
	 ...
	 *
	 * @generated from protobuf field: repeated rtd.rpc.v2.Event events = 3;
	 */
	events: Event[];
}
/**
 * An event.
 *
 * @generated from protobuf message rtd.rpc.v2.Event
 */
export interface Event {
	 ...
	 *
	 * @generated from protobuf field: optional rtd.rpc.v2.Bcs contents = 5;
	 */
	contents?: Bcs;
	/**
...
class TransactionEvents$Type extends MessageType<TransactionEvents> {
	constructor() {
		super('rtd.rpc.v2.TransactionEvents', [
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.TransactionEvents
 */
export const TransactionEvents = new TransactionEvents$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Event$Type extends MessageType<Event> {
	constructor() {
		super('rtd.rpc.v2.Event', [
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.Event
 */
