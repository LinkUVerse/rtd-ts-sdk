...
// @generated from protobuf file "rtd/rpc/v2/checkpoint.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Wenchuan Tech, Inc.
...
/**
 * @generated from protobuf message rtd.rpc.v2.Checkpoint
 */
export interface Checkpoint {
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.CheckpointSummary summary = 3
     */
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.ValidatorAggregatedSignature signature = 4
     */
    signature?: ValidatorAggregatedSignature;
    /**
     * The `CheckpointContents` for this checkpoint.
     *
     * @generated from protobuf field: optional rtd.rpc.v2.CheckpointContents contents = 5
     */
    contents?: CheckpointContents;
    /**
     * List of transactions included in this checkpoint.
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.ExecutedTransaction transactions = 6
     */
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.ObjectSet objects = 7
     */
    objects?: ObjectSet;
}
...
class Checkpoint$Type extends MessageType<Checkpoint> {
    constructor() {
        super("rtd.rpc.v2.Checkpoint", [
            ...
            { no: 6, name: "transactions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ExecutedTransaction },
            { no: 7, name: "objects", kind: "message", T: () => ObjectSet }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.Checkpoint
 */
