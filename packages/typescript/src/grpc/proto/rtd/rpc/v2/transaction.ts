...
export interface TransactionExpiration {
	 ...
	 *
	 * @generated from protobuf field: optional rtd.rpc.v2.AllowedProposers allowed_proposers = 8;
	 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.AllowedProposers
 */
		...
		super('rtd.rpc.v2.TransactionExpiration', [
			{
				...
				opt: true,
				T: () => [
					'rtd.rpc.v2.TransactionExpiration.TransactionExpirationKind',
...
class AllowedProposers$Type extends MessageType<AllowedProposers> {
	constructor() {
		super('rtd.rpc.v2.AllowedProposers', [
			{
				no: 1,
				name: 'epoch',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.AllowedProposers
 */
		...
		super('rtd.rpc.v2.TransactionKind', [
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['rtd.rpc.v2.TransactionKind.Kind', TransactionKind_Kind],
			},
			{
				no: 2,
		...
		super('rtd.rpc.v2.EndOfEpochTransactionKind', [
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['rtd.rpc.v2.EndOfEpochTransactionKind.Kind', EndOfEpochTransactionKind_Kind],
			},
		...
		super('rtd.rpc.v2.ExecutionTimeObservation', [
			{
				...
				opt: true,
				T: () => [
					'rtd.rpc.v2.ExecutionTimeObservation.ExecutionTimeObservationKind',
