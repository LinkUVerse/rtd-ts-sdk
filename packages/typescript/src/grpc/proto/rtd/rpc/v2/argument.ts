...
// @generated from protobuf file "rtd/rpc/v2/argument.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Wenchuan Tech, Inc.
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.Argument
 */
export interface Argument {
    /**
     * @generated from protobuf field: optional rtd.rpc.v2.Argument.ArgumentKind kind = 1
     */
...
/**
 * @generated from protobuf enum rtd.rpc.v2.Argument.ArgumentKind
 */
...
class Argument$Type extends MessageType<Argument> {
    constructor() {
        super("rtd.rpc.v2.Argument", [
            { no: 1, name: "kind", kind: "enum", opt: true, T: () => ["rtd.rpc.v2.Argument.ArgumentKind", Argument_ArgumentKind] },
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.Argument
 */
