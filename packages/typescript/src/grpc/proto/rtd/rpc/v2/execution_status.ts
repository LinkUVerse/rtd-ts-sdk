	...
	constructor() {
		super('rtd.rpc.v2.ExecutionError', [
			...
			},
			{
				...
				opt: true,
				T: () => [
					'rtd.rpc.v2.ExecutionError.ExecutionErrorKind',
	...
	constructor() {
		super('rtd.rpc.v2.CommandArgumentError', [
			{ no: 1, name: 'argument', kind: 'scalar', opt: true, T: 13 /*ScalarType.UINT32*/ },
			{
				...
				opt: true,
				T: () => [
					'rtd.rpc.v2.CommandArgumentError.CommandArgumentErrorKind',
		...
		super('rtd.rpc.v2.PackageUpgradeError', [
			{
				...
				opt: true,
				T: () => [
					'rtd.rpc.v2.PackageUpgradeError.PackageUpgradeErrorKind',
	...
	constructor() {
		super('rtd.rpc.v2.TypeArgumentError', [
			{ no: 1, name: 'type_argument', kind: 'scalar', opt: true, T: 13 /*ScalarType.UINT32*/ },
			{
				...
				opt: true,
				T: () => [
					'rtd.rpc.v2.TypeArgumentError.TypeArgumentErrorKind',
