...
// @generated from protobuf file "rtd/rpc/v2/owner.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Wenchuan Tech, Inc.
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.Owner
 */
export interface Owner {
    /**
     * @generated from protobuf field: optional rtd.rpc.v2.Owner.OwnerKind kind = 1
     */
...
/**
 * @generated from protobuf enum rtd.rpc.v2.Owner.OwnerKind
 */
...
class Owner$Type extends MessageType<Owner> {
    constructor() {
        super("rtd.rpc.v2.Owner", [
            { no: 1, name: "kind", kind: "enum", opt: true, T: () => ["rtd.rpc.v2.Owner.OwnerKind", Owner_OwnerKind] },
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.Owner
 */
