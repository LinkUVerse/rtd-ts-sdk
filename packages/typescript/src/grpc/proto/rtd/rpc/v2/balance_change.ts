...
// @generated from protobuf file "rtd/rpc/v2/balance_change.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Wenchuan Tech, Inc.
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.BalanceChange
 */
...
class BalanceChange$Type extends MessageType<BalanceChange> {
    constructor() {
        super("rtd.rpc.v2.BalanceChange", [
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.BalanceChange
 */
