	...
	constructor() {
		super('rtd.rpc.v2.DatatypeDescriptor', [
			...
			},
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['rtd.rpc.v2.DatatypeDescriptor.DatatypeKind', DatatypeDescriptor_DatatypeKind],
			},
			{
				no: 8,
				name: 'fields',
		...
		super('rtd.rpc.v2.OpenSignatureBody', [
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['rtd.rpc.v2.OpenSignatureBody.Type', OpenSignatureBody_Type],
			},
	...
	constructor() {
		super('rtd.rpc.v2.FunctionDescriptor', [
			{ no: 1, name: 'name', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['rtd.rpc.v2.FunctionDescriptor.Visibility', FunctionDescriptor_Visibility],
			},
		...
		super('rtd.rpc.v2.OpenSignature', [
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['rtd.rpc.v2.OpenSignature.Reference', OpenSignature_Reference],
			},
