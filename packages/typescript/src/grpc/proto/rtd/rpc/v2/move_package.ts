...
// @generated from protobuf file "rtd/rpc/v2/move_package.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Wenchuan Tech, Inc.
 ...
 * A Move Package
 *
 * @generated from protobuf message rtd.rpc.v2.Package
 */
export interface Package {
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.Module modules = 4
     */
    modules: Module[];
    /**
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.TypeOrigin type_origins = 5
     */
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.Linkage linkage = 6
     */
    linkage: Linkage[];
}
/**
 * A Move Module.
 *
 * @generated from protobuf message rtd.rpc.v2.Module
 */
export interface Module {
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.DatatypeDescriptor datatypes = 3
     */
    datatypes: DatatypeDescriptor[];
    /**
     * List of Functions defined by this module.
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.FunctionDescriptor functions = 4
     */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.DatatypeDescriptor
 */
export interface DatatypeDescriptor {
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.Ability abilities = 5
     */
    abilities: Ability[];
    /**
     * Ability constraints and phantom status for this type's generic type parameters
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.TypeParameter type_parameters = 6
     */
    typeParameters: TypeParameter[];
    /**
     * Indicates whether this datatype is a 'STRUCT' or an 'ENUM'
     *
     * @generated from protobuf field: optional rtd.rpc.v2.DatatypeDescriptor.DatatypeKind kind = 7
     */
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.FieldDescriptor fields = 8
     */
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.VariantDescriptor variants = 9
     */
    variants: VariantDescriptor[];
}
/**
 * @generated from protobuf enum rtd.rpc.v2.DatatypeDescriptor.DatatypeKind
 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.TypeParameter
 */
export interface TypeParameter {
    /**
     * The type parameter constraints
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.Ability constraints = 1
     */
    constraints: Ability[];
    /**
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.FieldDescriptor
 */
export interface FieldDescriptor {
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.OpenSignatureBody type = 3
     */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.VariantDescriptor
 */
export interface VariantDescriptor {
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.FieldDescriptor fields = 3
     */
    fields: FieldDescriptor[];
}
/**
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.OpenSignatureBody
 */
export interface OpenSignatureBody {
    /**
     * Type of this signature
     *
     * @generated from protobuf field: optional rtd.rpc.v2.OpenSignatureBody.Type type = 1
     */
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.OpenSignatureBody type_parameter_instantiation = 3
     */
...
/**
 * @generated from protobuf enum rtd.rpc.v2.OpenSignatureBody.Type
 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.FunctionDescriptor
 */
export interface FunctionDescriptor {
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.FunctionDescriptor.Visibility visibility = 5
     */
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.TypeParameter type_parameters = 7
     */
    typeParameters: TypeParameter[];
    /**
     * Formal parameter types.
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.OpenSignature parameters = 8
     */
    parameters: OpenSignature[];
    /**
     * Return types.
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.OpenSignature returns = 9
     */
    returns: OpenSignature[];
}
/**
 * @generated from protobuf enum rtd.rpc.v2.FunctionDescriptor.Visibility
 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.OpenSignature
 */
export interface OpenSignature {
    /**
     * @generated from protobuf field: optional rtd.rpc.v2.OpenSignature.Reference reference = 1
     */
    reference?: OpenSignature_Reference;
    /**
     * @generated from protobuf field: optional rtd.rpc.v2.OpenSignatureBody body = 2
     */
    body?: OpenSignatureBody;
}
/**
 * @generated from protobuf enum rtd.rpc.v2.OpenSignature.Reference
 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.TypeOrigin
 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.Linkage
 */
 ...
 *
 * @generated from protobuf enum rtd.rpc.v2.Ability
 */
export enum Ability {
    /**
...
class Package$Type extends MessageType<Package> {
    constructor() {
        super("rtd.rpc.v2.Package", [
            ...
            { no: 4, name: "modules", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Module },
            { no: 5, name: "type_origins", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TypeOrigin },
            { no: 6, name: "linkage", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Linkage }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.Package
 */
export const Package = new Package$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Module$Type extends MessageType<Module> {
    constructor() {
        super("rtd.rpc.v2.Module", [
            { no: 1, name: "name", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "contents", kind: "scalar", opt: true, T: 12 /*ScalarType.BYTES*/ },
            { no: 3, name: "datatypes", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DatatypeDescriptor },
            { no: 4, name: "functions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => FunctionDescriptor }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.Module
 */
export const Module = new Module$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DatatypeDescriptor$Type extends MessageType<DatatypeDescriptor> {
    constructor() {
        super("rtd.rpc.v2.DatatypeDescriptor", [
            ...
            { no: 5, name: "abilities", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["rtd.rpc.v2.Ability", Ability] },
            { no: 6, name: "type_parameters", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TypeParameter },
            { no: 7, name: "kind", kind: "enum", opt: true, T: () => ["rtd.rpc.v2.DatatypeDescriptor.DatatypeKind", DatatypeDescriptor_DatatypeKind] },
            { no: 8, name: "fields", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => FieldDescriptor },
            { no: 9, name: "variants", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => VariantDescriptor }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.DatatypeDescriptor
 */
export const DatatypeDescriptor = new DatatypeDescriptor$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TypeParameter$Type extends MessageType<TypeParameter> {
    constructor() {
        super("rtd.rpc.v2.TypeParameter", [
            { no: 1, name: "constraints", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["rtd.rpc.v2.Ability", Ability] },
            { no: 2, name: "is_phantom", kind: "scalar", opt: true, T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.TypeParameter
 */
export const TypeParameter = new TypeParameter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class FieldDescriptor$Type extends MessageType<FieldDescriptor> {
    constructor() {
        super("rtd.rpc.v2.FieldDescriptor", [
            { no: 1, name: "name", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.FieldDescriptor
 */
export const FieldDescriptor = new FieldDescriptor$Type();
// @generated message type with reflection information, may provide speed optimized methods
class VariantDescriptor$Type extends MessageType<VariantDescriptor> {
    constructor() {
        super("rtd.rpc.v2.VariantDescriptor", [
            { no: 1, name: "name", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "position", kind: "scalar", opt: true, T: 13 /*ScalarType.UINT32*/ },
            { no: 3, name: "fields", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => FieldDescriptor }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.VariantDescriptor
 */
...
class OpenSignatureBody$Type extends MessageType<OpenSignatureBody> {
    constructor() {
        super("rtd.rpc.v2.OpenSignatureBody", [
            { no: 1, name: "type", kind: "enum", opt: true, T: () => ["rtd.rpc.v2.OpenSignatureBody.Type", OpenSignatureBody_Type] },
            { no: 2, name: "type_name", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "type_parameter_instantiation", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => OpenSignatureBody },
            { no: 4, name: "type_parameter", kind: "scalar", opt: true, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.OpenSignatureBody
 */
...
class FunctionDescriptor$Type extends MessageType<FunctionDescriptor> {
    constructor() {
        super("rtd.rpc.v2.FunctionDescriptor", [
            { no: 1, name: "name", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
            { no: 5, name: "visibility", kind: "enum", opt: true, T: () => ["rtd.rpc.v2.FunctionDescriptor.Visibility", FunctionDescriptor_Visibility] },
            { no: 6, name: "is_entry", kind: "scalar", opt: true, T: 8 /*ScalarType.BOOL*/ },
            { no: 7, name: "type_parameters", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TypeParameter },
            { no: 8, name: "parameters", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => OpenSignature },
            { no: 9, name: "returns", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => OpenSignature }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.FunctionDescriptor
 */
export const FunctionDescriptor = new FunctionDescriptor$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OpenSignature$Type extends MessageType<OpenSignature> {
    constructor() {
        super("rtd.rpc.v2.OpenSignature", [
            { no: 1, name: "reference", kind: "enum", opt: true, T: () => ["rtd.rpc.v2.OpenSignature.Reference", OpenSignature_Reference] },
            { no: 2, name: "body", kind: "message", T: () => OpenSignatureBody }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.OpenSignature
 */
export const OpenSignature = new OpenSignature$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TypeOrigin$Type extends MessageType<TypeOrigin> {
    constructor() {
        super("rtd.rpc.v2.TypeOrigin", [
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.Linkage
 */
