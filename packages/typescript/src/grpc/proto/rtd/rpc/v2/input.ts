...
// @generated from protobuf file "rtd/rpc/v2/input.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Wenchuan Tech, Inc.
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.Input
 */
export interface Input {
    /**
     * @generated from protobuf field: optional rtd.rpc.v2.Input.InputKind kind = 1
     */
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.Input.Mutability mutability = 7
     */
    mutability?: Input_Mutability;
    /**
     * Fund Reservation information if `kind` is `FUNDS_WITHDRAWAL`.
     *
     * @generated from protobuf field: optional rtd.rpc.v2.FundsWithdrawal funds_withdrawal = 8
     */
...
/**
 * @generated from protobuf enum rtd.rpc.v2.Input.InputKind
 */
...
/**
 * @generated from protobuf enum rtd.rpc.v2.Input.Mutability
 */
...
/**
 * @generated from protobuf message rtd.rpc.v2.FundsWithdrawal
 */
export interface FundsWithdrawal {
    ...
    coinType?: string;
    /**
     * @generated from protobuf field: optional rtd.rpc.v2.FundsWithdrawal.Source source = 3
     */
    source?: FundsWithdrawal_Source;
}
/**
 * @generated from protobuf enum rtd.rpc.v2.FundsWithdrawal.Source
 */
...
class Input$Type extends MessageType<Input> {
    constructor() {
        super("rtd.rpc.v2.Input", [
            { no: 1, name: "kind", kind: "enum", opt: true, T: () => ["rtd.rpc.v2.Input.InputKind", Input_InputKind] },
            ...
            { no: 7, name: "mutability", kind: "enum", opt: true, T: () => ["rtd.rpc.v2.Input.Mutability", Input_Mutability] },
...
class FundsWithdrawal$Type extends MessageType<FundsWithdrawal> {
    constructor() {
        super("rtd.rpc.v2.FundsWithdrawal", [
            ...
            { no: 3, name: "source", kind: "enum", opt: true, T: () => ["rtd.rpc.v2.FundsWithdrawal.Source", FundsWithdrawal_Source] }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.FundsWithdrawal
 */
