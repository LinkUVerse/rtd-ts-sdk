...
/**
 * @generated from protobuf service rtd.rpc.v2.MovePackageService
 */
export interface IMovePackageServiceClient {
	/**
	 * @generated from protobuf rpc: GetPackage(rtd.rpc.v2.GetPackageRequest) returns (rtd.rpc.v2.GetPackageResponse);
	 */
	getPackage(
	...
	/**
	 * @generated from protobuf rpc: GetDatatype(rtd.rpc.v2.GetDatatypeRequest) returns (rtd.rpc.v2.GetDatatypeResponse);
	 */
	getDatatype(
	...
	/**
	 * @generated from protobuf rpc: GetFunction(rtd.rpc.v2.GetFunctionRequest) returns (rtd.rpc.v2.GetFunctionResponse);
	 */
	getFunction(
	...
	/**
	 * @generated from protobuf rpc: ListPackageVersions(rtd.rpc.v2.ListPackageVersionsRequest) returns (rtd.rpc.v2.ListPackageVersionsResponse);
	 */
	listPackageVersions(
