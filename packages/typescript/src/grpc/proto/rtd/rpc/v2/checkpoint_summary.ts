...
// @generated from protobuf file "rtd/rpc/v2/checkpoint_summary.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Wenchuan Tech, Inc.
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.CheckpointSummary
 */
export interface CheckpointSummary {
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.GasCostSummary epoch_rolling_gas_cost_summary = 8
     */
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.CheckpointCommitment commitments = 10
     */
    commitments: CheckpointCommitment[];
    /**
     * Extra data only present in the final checkpoint of an epoch.
     *
     * @generated from protobuf field: optional rtd.rpc.v2.EndOfEpochData end_of_epoch_data = 11
     */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.EndOfEpochData
 */
export interface EndOfEpochData {
    /**
     * The set of validators that will be in the `ValidatorCommittee` for the next epoch.
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.ValidatorCommitteeMember next_epoch_committee = 1
     */
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.CheckpointCommitment epoch_commitments = 3
     */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.CheckpointCommitment
 */
export interface CheckpointCommitment {
    /**
     * @generated from protobuf field: optional rtd.rpc.v2.CheckpointCommitment.CheckpointCommitmentKind kind = 1
     */
...
/**
 * @generated from protobuf enum rtd.rpc.v2.CheckpointCommitment.CheckpointCommitmentKind
 */
...
class CheckpointSummary$Type extends MessageType<CheckpointSummary> {
    constructor() {
        super("rtd.rpc.v2.CheckpointSummary", [
            ...
            { no: 10, name: "commitments", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CheckpointCommitment },
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.CheckpointSummary
 */
export const CheckpointSummary = new CheckpointSummary$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EndOfEpochData$Type extends MessageType<EndOfEpochData> {
    constructor() {
        super("rtd.rpc.v2.EndOfEpochData", [
            { no: 1, name: "next_epoch_committee", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ValidatorCommitteeMember },
            { no: 2, name: "next_epoch_protocol_version", kind: "scalar", opt: true, T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "epoch_commitments", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CheckpointCommitment }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.EndOfEpochData
 */
...
class CheckpointCommitment$Type extends MessageType<CheckpointCommitment> {
    constructor() {
        super("rtd.rpc.v2.CheckpointCommitment", [
            { no: 1, name: "kind", kind: "enum", opt: true, T: () => ["rtd.rpc.v2.CheckpointCommitment.CheckpointCommitmentKind", CheckpointCommitment_CheckpointCommitmentKind] },
            { no: 2, name: "digest", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.CheckpointCommitment
 */
