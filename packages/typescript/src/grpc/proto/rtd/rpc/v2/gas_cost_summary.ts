...
// @generated from protobuf file "rtd/rpc/v2/gas_cost_summary.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) LinkU Labs, Inc.
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.GasCostSummary
 */
...
class GasCostSummary$Type extends MessageType<GasCostSummary> {
	constructor() {
		super('rtd.rpc.v2.GasCostSummary', [
			{
				no: 1,
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.GasCostSummary
 */
