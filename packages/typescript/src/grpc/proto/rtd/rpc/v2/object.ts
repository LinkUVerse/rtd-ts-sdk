...
// @generated from protobuf file "rtd/rpc/v2/object.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) LinkU Labs, Inc.
...
export interface Object {
	 ...
	 * Owner of the object.
	 *
	 * @generated from protobuf field: optional rtd.rpc.v2.Owner owner = 5;
	 */
	owner?: Owner;
	/**
	 ...
	 * Only set for Move structs
	 *
	 * @generated from protobuf field: optional rtd.rpc.v2.Bcs contents = 8;
	 */
	contents?: Bcs;
	/**
	 * Package information for Move Packages
	 *
	 * @generated from protobuf field: optional rtd.rpc.v2.Package package = 9;
	 */
	package?: Package;
	/**
	 ...
	 *
	 * @generated from protobuf field: optional rtd.rpc.v2.Display display = 102;
	 */
	display?: Display;
}
/**
 * Set of Objects
 *
 * @generated from protobuf message rtd.rpc.v2.ObjectSet
 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.Display
 */
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.Object
 */
export const Object = new Object$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ObjectSet$Type extends MessageType<ObjectSet> {
	constructor() {
		super('rtd.rpc.v2.ObjectSet', [
			{
				no: 1,
				name: 'objects',
				kind: 'message',
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.ObjectSet
 */
export const ObjectSet = new ObjectSet$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Display$Type extends MessageType<Display> {
	constructor() {
		super('rtd.rpc.v2.Display', [
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.Display
 */
