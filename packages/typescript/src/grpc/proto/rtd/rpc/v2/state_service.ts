	...
	constructor() {
		super('rtd.rpc.v2.CoinMetadata', [
			...
			{ no: 7, name: 'metadata_cap_id', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['rtd.rpc.v2.CoinMetadata.MetadataCapState', CoinMetadata_MetadataCapState],
			},
		]);
	}
}
	...
	constructor() {
		super('rtd.rpc.v2.CoinTreasury', [
			...
			},
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['rtd.rpc.v2.CoinTreasury.SupplyState', CoinTreasury_SupplyState],
			},
		]);
	}
}
	...
	constructor() {
		super('rtd.rpc.v2.RegulatedCoinMetadata', [
			...
			{ no: 5, name: 'variant', kind: 'scalar', opt: true, T: 13 /*ScalarType.UINT32*/ },
			{
				...
				opt: true,
				T: () => [
					'rtd.rpc.v2.RegulatedCoinMetadata.CoinRegulatedState',
		...
		super('rtd.rpc.v2.DynamicField', [
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['rtd.rpc.v2.DynamicField.DynamicFieldKind', DynamicField_DynamicFieldKind],
			},
