 ...
 *
 * @generated from protobuf message rtd.rpc.v2.EventDigestEntry
 */
...
export interface AccumulatorWrite {
	...
	/**
	 * @generated from protobuf field: optional rtd.rpc.v2.AccumulatorWrite.AccumulatorValue value_kind = 4;
	 */
	 ...
	 *
	 * @generated from protobuf field: repeated rtd.rpc.v2.EventDigestEntry event_digest_value = 7;
	 */
...
/**
 * @generated from protobuf enum rtd.rpc.v2.AccumulatorWrite.AccumulatorValue
 */
	...
	constructor() {
		super('rtd.rpc.v2.ChangedObject', [
			{ no: 1, name: 'object_id', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
			{
				...
				opt: true,
				T: () => [
					'rtd.rpc.v2.ChangedObject.InputObjectState',
			...
			{ no: 5, name: 'input_owner', kind: 'message', T: () => Owner },
			{
				...
				opt: true,
				T: () => [
					'rtd.rpc.v2.ChangedObject.OutputObjectState',
			...
			{ no: 12, name: 'accumulator_write', kind: 'message', T: () => AccumulatorWrite },
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['rtd.rpc.v2.ChangedObject.IdOperation', ChangedObject_IdOperation],
			},
...
class EventDigestEntry$Type extends MessageType<EventDigestEntry> {
	constructor() {
		super('rtd.rpc.v2.EventDigestEntry', [
			{
				no: 1,
				name: 'event_index',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.EventDigestEntry
 */
	...
	constructor() {
		super('rtd.rpc.v2.AccumulatorWrite', [
			...
			{ no: 2, name: 'accumulator_type', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
			{
				...
				opt: true,
				T: () => [
					'rtd.rpc.v2.AccumulatorWrite.AccumulatorOperation',
			...
			},
			{
				...
				opt: true,
				T: () => [
					'rtd.rpc.v2.AccumulatorWrite.AccumulatorValue',
		...
		super('rtd.rpc.v2.UnchangedConsensusObject', [
			{
				...
				opt: true,
				T: () => [
					'rtd.rpc.v2.UnchangedConsensusObject.UnchangedConsensusObjectKind',
