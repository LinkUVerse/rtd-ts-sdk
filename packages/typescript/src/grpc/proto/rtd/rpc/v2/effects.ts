...
// @generated from protobuf file "rtd/rpc/v2/effects.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Wenchuan Tech, Inc.
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.TransactionEffects
 */
export interface TransactionEffects {
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.ExecutionStatus status = 4
     */
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.GasCostSummary gas_used = 6
     */
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.ChangedObject gas_object = 8
     */
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.ChangedObject changed_objects = 12
     */
     ...
     *
     * @generated from protobuf field: repeated rtd.rpc.v2.UnchangedConsensusObject unchanged_consensus_objects = 13
     */
    ...
    /**
     * @generated from protobuf field: repeated rtd.rpc.v2.ObjectReference unchanged_loaded_runtime_objects = 15
     */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.ChangedObject
 */
export interface ChangedObject {
    ...
    objectId?: string;
    /**
     * @generated from protobuf field: optional rtd.rpc.v2.ChangedObject.InputObjectState input_state = 2
     */
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.Owner input_owner = 5
     */
    inputOwner?: Owner;
    /**
     * @generated from protobuf field: optional rtd.rpc.v2.ChangedObject.OutputObjectState output_state = 6
     */
     ...
     *
     * @generated from protobuf field: optional rtd.rpc.v2.Owner output_owner = 9
     */
    outputOwner?: Owner;
    /**
     * The contents of the accumulator write when `output_state` is `OUTPUT_OBJECT_STATE_ACCUMULATOR_WRITE`
     *
     * @generated from protobuf field: optional rtd.rpc.v2.AccumulatorWrite accumulator_write = 12
     */
    accumulatorWrite?: AccumulatorWrite;
    /**
     * What happened to an `ObjectId` during execution.
     *
     * @generated from protobuf field: optional rtd.rpc.v2.ChangedObject.IdOperation id_operation = 10
     */
...
/**
 * @generated from protobuf enum rtd.rpc.v2.ChangedObject.InputObjectState
 */
...
/**
 * @generated from protobuf enum rtd.rpc.v2.ChangedObject.OutputObjectState
 */
...
/**
 * @generated from protobuf enum rtd.rpc.v2.ChangedObject.IdOperation
 */
...
/**
 * @generated from protobuf message rtd.rpc.v2.AccumulatorWrite
 */
export interface AccumulatorWrite {
    ...
    /**
     * @generated from protobuf field: optional rtd.rpc.v2.AccumulatorWrite.AccumulatorOperation operation = 3
     */
...
/**
 * @generated from protobuf enum rtd.rpc.v2.AccumulatorWrite.AccumulatorOperation
 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.UnchangedConsensusObject
 */
export interface UnchangedConsensusObject {
    /**
     * @generated from protobuf field: optional rtd.rpc.v2.UnchangedConsensusObject.UnchangedConsensusObjectKind kind = 1
     */
...
/**
 * @generated from protobuf enum rtd.rpc.v2.UnchangedConsensusObject.UnchangedConsensusObjectKind
 */
...
class TransactionEffects$Type extends MessageType<TransactionEffects> {
    constructor() {
        super("rtd.rpc.v2.TransactionEffects", [
            ...
            { no: 12, name: "changed_objects", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ChangedObject },
            { no: 13, name: "unchanged_consensus_objects", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UnchangedConsensusObject },
            { no: 14, name: "auxiliary_data_digest", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
            { no: 15, name: "unchanged_loaded_runtime_objects", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ObjectReference }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.TransactionEffects
 */
export const TransactionEffects = new TransactionEffects$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ChangedObject$Type extends MessageType<ChangedObject> {
    constructor() {
        super("rtd.rpc.v2.ChangedObject", [
            { no: 1, name: "object_id", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "input_state", kind: "enum", opt: true, T: () => ["rtd.rpc.v2.ChangedObject.InputObjectState", ChangedObject_InputObjectState, "INPUT_OBJECT_STATE_"] },
            ...
            { no: 6, name: "output_state", kind: "enum", opt: true, T: () => ["rtd.rpc.v2.ChangedObject.OutputObjectState", ChangedObject_OutputObjectState, "OUTPUT_OBJECT_STATE_"] },
            ...
            { no: 10, name: "id_operation", kind: "enum", opt: true, T: () => ["rtd.rpc.v2.ChangedObject.IdOperation", ChangedObject_IdOperation] },
            { no: 11, name: "object_type", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.ChangedObject
 */
export const ChangedObject = new ChangedObject$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AccumulatorWrite$Type extends MessageType<AccumulatorWrite> {
    constructor() {
        super("rtd.rpc.v2.AccumulatorWrite", [
            ...
            { no: 3, name: "operation", kind: "enum", opt: true, T: () => ["rtd.rpc.v2.AccumulatorWrite.AccumulatorOperation", AccumulatorWrite_AccumulatorOperation] },
            { no: 5, name: "value", kind: "scalar", opt: true, T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.AccumulatorWrite
 */
...
class UnchangedConsensusObject$Type extends MessageType<UnchangedConsensusObject> {
    constructor() {
        super("rtd.rpc.v2.UnchangedConsensusObject", [
            { no: 1, name: "kind", kind: "enum", opt: true, T: () => ["rtd.rpc.v2.UnchangedConsensusObject.UnchangedConsensusObjectKind", UnchangedConsensusObject_UnchangedConsensusObjectKind] },
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.UnchangedConsensusObject
 */
