...
// @generated from protobuf file "rtd/rpc/v2/subscription_service.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) LinkU Labs, Inc.
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.SubscribeCheckpointsRequest
 */
export interface SubscribeCheckpointsRequest {
	 ...
	 *
	 * @generated from protobuf field: optional rtd.rpc.v2.TransactionFilter filter = 2;
	 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.SubscribeCheckpointsResponse
 */
export interface SubscribeCheckpointsResponse {
	 ...
	 *
	 * @generated from protobuf field: optional rtd.rpc.v2.Checkpoint checkpoint = 2;
	 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.SubscribeTransactionsRequest
 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.SubscribeTransactionsResponse
 */
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.SubscribeEventsRequest
 */
export interface SubscribeEventsRequest {
	 ...
	 * streamed.
	 *
	 * @generated from protobuf field: optional rtd.rpc.v2.EventFilter filter = 2;
	 */
	filter?: EventFilter;
}
/**
 ...
 *
 * @generated from protobuf message rtd.rpc.v2.SubscribeEventsResponse
 */
...
class SubscribeCheckpointsRequest$Type extends MessageType<SubscribeCheckpointsRequest> {
	constructor() {
		super('rtd.rpc.v2.SubscribeCheckpointsRequest', [
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.SubscribeCheckpointsRequest
 */
...
class SubscribeCheckpointsResponse$Type extends MessageType<SubscribeCheckpointsResponse> {
	constructor() {
		super('rtd.rpc.v2.SubscribeCheckpointsResponse', [
			{
				no: 1,
				name: 'cursor',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.SubscribeCheckpointsResponse
 */
...
class SubscribeTransactionsRequest$Type extends MessageType<SubscribeTransactionsRequest> {
	constructor() {
		super('rtd.rpc.v2.SubscribeTransactionsRequest', [
			{ no: 1, name: 'read_mask', kind: 'message', T: () => FieldMask },
			{ no: 2, name: 'filter', kind: 'message', T: () => TransactionFilter },
		]);
	}
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.SubscribeTransactionsRequest
 */
...
class SubscribeTransactionsResponse$Type extends MessageType<SubscribeTransactionsResponse> {
	constructor() {
		super('rtd.rpc.v2.SubscribeTransactionsResponse', [
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.SubscribeTransactionsResponse
 */
...
class SubscribeEventsRequest$Type extends MessageType<SubscribeEventsRequest> {
	constructor() {
		super('rtd.rpc.v2.SubscribeEventsRequest', [
			{ no: 1, name: 'read_mask', kind: 'message', T: () => FieldMask },
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.SubscribeEventsRequest
 */
...
class SubscribeEventsResponse$Type extends MessageType<SubscribeEventsResponse> {
	constructor() {
		super('rtd.rpc.v2.SubscribeEventsResponse', [
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.SubscribeEventsResponse
 */
export const SubscribeEventsResponse = new SubscribeEventsResponse$Type();
/**
 * @generated ServiceType for protobuf service rtd.rpc.v2.SubscriptionService
 */
export const SubscriptionService = new ServiceType('rtd.rpc.v2.SubscriptionService', [
	{
