...
// @generated from protobuf file "rtd/rpc/v2/protocol_config.proto" (package "rtd.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Wenchuan Tech, Inc.
...
/**
 * @generated from protobuf message rtd.rpc.v2.ProtocolConfig
 */
...
class ProtocolConfig$Type extends MessageType<ProtocolConfig> {
    constructor() {
        super("rtd.rpc.v2.ProtocolConfig", [
...
/**
 * @generated MessageType for protobuf message rtd.rpc.v2.ProtocolConfig
 */
