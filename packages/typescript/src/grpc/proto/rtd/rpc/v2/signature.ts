 ...
 *
 * See
 * [struct.PasskeyAuthenticator](https://mystenlabs.github.io/rtd-rust-sdk/rtd_sdk_types/struct.PasskeyAuthenticator.html#bcs)
	...
	constructor() {
		super('rtd.rpc.v2.UserSignature', [
			{ no: 1, name: 'bcs', kind: 'message', T: () => Bcs },
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['rtd.rpc.v2.SignatureScheme', SignatureScheme],
			},
