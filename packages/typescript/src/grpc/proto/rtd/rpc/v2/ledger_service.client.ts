...
/**
 * @generated from protobuf service rtd.rpc.v2.LedgerService
 */
export interface ILedgerServiceClient {
	/**
	 * Query the service for general information about its current state.
	 *
	 * @generated from protobuf rpc: GetServiceInfo(rtd.rpc.v2.GetServiceInfoRequest) returns (rtd.rpc.v2.GetServiceInfoResponse);
	 */
	getServiceInfo(
	...
	/**
	 * @generated from protobuf rpc: GetObject(rtd.rpc.v2.GetObjectRequest) returns (rtd.rpc.v2.GetObjectResponse);
	 */
	getObject(
	...
	/**
	 * @generated from protobuf rpc: BatchGetObjects(rtd.rpc.v2.BatchGetObjectsRequest) returns (rtd.rpc.v2.BatchGetObjectsResponse);
	 */
	batchGetObjects(
	...
	/**
	 * @generated from protobuf rpc: GetTransaction(rtd.rpc.v2.GetTransactionRequest) returns (rtd.rpc.v2.GetTransactionResponse);
	 */
	getTransaction(
	...
	/**
	 * @generated from protobuf rpc: BatchGetTransactions(rtd.rpc.v2.BatchGetTransactionsRequest) returns (rtd.rpc.v2.BatchGetTransactionsResponse);
	 */
	...
	/**
	 * @generated from protobuf rpc: GetCheckpoint(rtd.rpc.v2.GetCheckpointRequest) returns (rtd.rpc.v2.GetCheckpointResponse);
	 */
	getCheckpoint(
	...
	/**
	 * @generated from protobuf rpc: GetEpoch(rtd.rpc.v2.GetEpochRequest) returns (rtd.rpc.v2.GetEpochResponse);
	 */
	getEpoch(
	 ...
	 *
	 * @generated from protobuf rpc: ListCheckpoints(rtd.rpc.v2.ListCheckpointsRequest) returns (stream rtd.rpc.v2.ListCheckpointsResponse);
	 */
	listCheckpoints(
	 ...
	 *
	 * @generated from protobuf rpc: ListTransactions(rtd.rpc.v2.ListTransactionsRequest) returns (stream rtd.rpc.v2.ListTransactionsResponse);
	 */
	listTransactions(
	 ...
	 *
	 * @generated from protobuf rpc: ListEvents(rtd.rpc.v2.ListEventsRequest) returns (stream rtd.rpc.v2.ListEventsResponse);
	 */
	listEvents(
