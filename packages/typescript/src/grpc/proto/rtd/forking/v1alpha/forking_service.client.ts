...
/**
 * Administrative service for controlling a forked Rtd network.
 *
 * @generated from protobuf service rtd.forking.v1alpha.ForkingService
 */
export interface IForkingServiceClient {
	/**
	 * Advance the forked network's clock by a given duration.
	 *
	 * @generated from protobuf rpc: AdvanceClock(rtd.forking.v1alpha.AdvanceClockRequest) returns (rtd.forking.v1alpha.AdvanceClockResponse);
	 */
	advanceClock(
	 ...
	 *
	 * @generated from protobuf rpc: AdvanceCheckpoint(rtd.forking.v1alpha.AdvanceCheckpointRequest) returns (rtd.forking.v1alpha.AdvanceCheckpointResponse);
	 */
	advanceCheckpoint(
	 ...
	 *
	 * @generated from protobuf rpc: GetStatus(rtd.forking.v1alpha.GetStatusRequest) returns (rtd.forking.v1alpha.GetStatusResponse);
	 */
	getStatus(
