...
const MESSAGE_DECODED = Symbol.for('rtd-typescript/grpc/decoded-status-message');
 ...
 *
 * `RtdGrpcClient` builds one by default. A transport imported from `@protobuf-ts/grpcweb-transport`
