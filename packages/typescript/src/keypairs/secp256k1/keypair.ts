...
import { decodeRtdPrivateKey, encodeRtdPrivateKey, Keypair } from '../../cryptography/keypair.js';
...
export class Secp256k1Keypair extends Keypair {
	...
	static fromSecretKey(
		...
		if (!options || !options.skipValidation) {
			...
			const signData = encoder.encode('rtd validation');
	 ...
	 */
	getSecretKey(): string {
		return encodeRtdPrivateKey(this.keypair.secretKey, this.getKeyScheme());
	}
