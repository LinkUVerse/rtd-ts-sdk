...
describe('Keypair', () => {
	...
	it('`toRtdAddress()` should return a valid rtd address', async () => {
		expect(k1.toRtdAddress()).toEqual(pk1.toRtdAddress());
		expect(k1.toRtdAddress()).toEqual(
			'0xafedf3bc60bd296aa6830d7c48ca44e0f7a32478ae4bd7b9a6ac1dc81ff7b29b',
		);

		expect(k2.toRtdAddress()).toEqual(pk2.toRtdAddress());
		expect(k2.toRtdAddress()).toEqual(
			'0x7e4f9a35bf3b5383802d990956d6f3c93e6184ebbbcf0820c124ab3a59ef77ac',
		);

		expect(k3.toRtdAddress()).toEqual(pk3.toRtdAddress());
