...
// cargo build --bin rtd
// ../rtd/target/debug/rtd client new-address secp256r1
// ../rtd/target/debug/rtd keytool list
const TEST_CASES = [
	{
		rawPublicKey: 'A8Ju2r5X3EZ3aYuZzH+Ofs6cd1j2WOwY7lhoJQenulBl',
		rtdPublicKey: 'AgPCbtq+V9xGd2mLmcx/jn7OnHdY9ljsGO5YaCUHp7pQZQ==',
		rtdAddress: '0xafd0f5a4f41c5770c201879518740b83743164ed2445016fbba9ae98e04af8a5',
	},
];
