...
import type { TransactionEffects as GrpcTransactionEffects } from '../../../src/grpc/proto/rtd/rpc/v2/effects.js';
import {
	ChangedObject_IdOperation,
	ChangedObject_InputObjectState,
	ChangedObject_OutputObjectState,
} from '../../../src/grpc/proto/rtd/rpc/v2/effects.js';
	...
	it('maps the placeholder 0x0 gas object to null', () => {
		...
		const { effects } = parseTransactionEffectsJson({
			effects: jsonRpcEffects({
				owner: { AddressOwner: normalizeRtdAddress('0x0') },
				reference: {
					objectId: normalizeRtdAddress('0x0'),
					version: '0',
