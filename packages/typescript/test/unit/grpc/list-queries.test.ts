...
import { GrpcTypes, RtdGrpcClient } from '../../../src/grpc/index.js';
...
function mockListTransactions(client: RtdGrpcClient, frames: GrpcTypes.ListTransactionsResponse[]) {
...
function mockListEvents(client: RtdGrpcClient, frames: GrpcTypes.ListEventsResponse[]) {
