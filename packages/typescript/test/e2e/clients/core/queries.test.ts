...
// TODO: Set this to [] once RTD_TOOLS_TAG points at an image that serves the
...
describe('Core API - Queries', () => {
	...
	function normalizeEvents(result: RtdClientTypes.ListEventsResponse) {
		return {
			...stripCursors(result),
	...
	describe('listEvents', () => {
		...
		it('all clients return same data: each filter predicate', async () => {
			const filters: RtdClientTypes.EventFilter[] = [
