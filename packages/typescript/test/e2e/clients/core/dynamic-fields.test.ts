...
import type { RtdGrpcClient } from '../../../../src/grpc/index.js';
import type { RtdGraphQLClient } from '../../../../src/graphql/index.js';
...
describe('Core API - Dynamic Fields', () => {
	...
	describe('listDynamicFields with include: { value: true }', () => {
		it('[gRPC] should return value BCS when include value is true', async () => {
			const grpcClient = toolbox.grpcClient as RtdGrpcClient;
		...
		it('[GraphQL] should return value BCS when include value is true', async () => {
			const graphqlClient = toolbox.graphqlClient as RtdGraphQLClient;
