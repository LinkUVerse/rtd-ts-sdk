...
import { RtdTransactionBlockResponse } from '../../../../src/jsonRpc/index.js';
import { Transaction } from '../../../../src/transactions/index.js';
import { executePayRtdNTimes, setup, TestToolbox } from '../../utils/setup.js';

describe('Transaction Reading API', () => {
	let toolbox: TestToolbox;
	let transactions: RtdTransactionBlockResponse[];
	const NUM_TRANSACTIONS = 10;

	beforeAll(async () => {
		toolbox = await setup();
		transactions = await executePayRtdNTimes(
