...
import { requestRtdFromFaucetV2, FaucetRateLimitError } from '../../../src/faucet/index.js';
import { Transaction } from '../../../src/transactions/index.js';
import { normalizeRtdAddress } from '../../../src/utils/index.js';
import { RtdGrpcClient } from '../../../src/grpc/client.js';
...
export async function prePublishPackages(
	...
	// Publish each package. The default rtd config at /root/.rtd/rtd_config/client.yaml
...
async function publishSinglePackage(options: {
	...
	const packageId = normalizeRtdAddress(publishedChange.objectId);
...
async function setupDemoBearDisplayV2(options: {
	...
	const DISPLAY_REGISTRY_ID = normalizeRtdAddress('0xd');
