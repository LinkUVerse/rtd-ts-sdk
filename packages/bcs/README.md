...
To install, add the [`rtd-bcs`](https://www.npmjs.com/package/rtd-bcs) package to your
project:
...
The `rtd-bcs` library can be used to define schemas that can serialize and deserialize BCS
